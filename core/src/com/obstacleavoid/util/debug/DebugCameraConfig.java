...
public class DebugCameraConfig {
    ...
    private static int getInputKeyValue(JsonValue root, String name, int defaultInputValue) {
        String keyString = root.getString(name, Input.Keys.toString(defaultInputValue));
